...
#
# WARN(29/12/2019); It's _NOT_ possible to execute the default script embedded on the device
# (as far a i know..). We need to keep this file updated with the latest default configuration
# changes!
#------------------------------------------------------------------------------------
